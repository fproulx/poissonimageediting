...
import util.io.FileTreeWalk;
import util.io.FileTreeWalker;
import util.io.UnixGlobFileFilter;
...
public class ImageBrowser extends JComponent 
    ...
    public ImageBrowser() {
        ...
        for (int i = 0; i < images.size(); ++i) {
            ...
            label[i].addMouseListener(new ImageBrowserMouseListener(i));

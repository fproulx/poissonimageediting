...
/**
 * Simple AbstractPhotomontage implementation for testing purposes. Outputs all of the files in the photomontage to viewable files
 *  
 * @author Olivier Bilodeau
 */
public class PhotomontageToFiles extends AbstractPhotomontage {
	 ...
	 */
	public PhotomontageToFiles(BufferedImage srcImage, BufferedImage maskImage, BufferedImage destImage, Point destPosition) {
